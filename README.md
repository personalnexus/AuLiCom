...
**AuLiComXL** is an Excel plugin (based on ExcelDNA) to manage channel values, fixtures and scenes. As of Jun 2023, this is the most complete interface to the AuLiCom functionality.
